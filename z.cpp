...
public:
    ...
    void addDish(Dish dish) {
        if (std::find_if(dishes.begin(), dishes.end(), [&](const Dish& d) { return d.dishID == dish.dishID; }) != dishes.end()) {
            std::cout << "Dish ID already exists. Returning to main menu.\n";
            return;
        }
...
int main() {
    ...
    do {
        ...
        std::cout << "8. Display Materials\n";
        std::cout << "9. Display Dishes\n";
        std::cout << "10. Display Customers\n";
        std::cout << "11. Display Orders\n";
        std::cout << "12. Display Notifications\n";
        std::cout << "13. Calculate Finance\n";
        std::cout << "14. Modify User\n";
        std::cout << "15. Modify Material\n";
        std::cout << "16. Modify Dish\n";
        std::cout << "17. Modify Customer\n";
        std::cout << "18. Modify Order\n";
        std::cout << "19. Modify Notification\n";
        std::cout << "0. Exit\n";
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Material ID. Returning to main menu.\n";
                    break;
                }
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Material Price. Returning to main menu.\n";
                    break;
                }
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Quantity. Returning to main menu.\n";
                    break;
                }
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Warning Threshold. Returning to main menu.\n";
                    break;
                }
            ...
            case 3: {
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Dish ID. Returning to main menu.\n";
                    break;
                }
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Dish Price. Returning to main menu.\n";
                    break;
                }
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid number of ingredients. Returning to main menu.\n";
                    break;
                }
                std::vector<Material> ingredients;
                for (int i = 0; i < numIngredients; ++i) {
            ...
            case 4: {
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Customer ID. Returning to main menu.\n";
                    break;
                }
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Points. Returning to main menu.\n";
                    break;
                }
            ...
            case 5: {
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid Order ID. Returning to main menu.\n";
                    break;
                }
                std::cout << "Enter Customer ID: ";
                std::cin >> customerID;
                ...
                if (std::cin.fail()) {
                    std::cin.clear();
                    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Invalid number of dishes. Returning to main menu.\n";
                    break;
                }
                std::vector<Dish> dishes;
                for (int i = 0; i < numDishes; ++i) {
